...
('11111111-1111-1111-1111-111111111111', 'AT_RISK', 'planner@demo', 'dram_ddr5',
 ...
 76, 0.71, 17, '{"signals":["price_index_up","otif_down","spot_availability_down"]}'::jsonb, '2025-W03', now() - interval '28 hours', now() - interval '3 hours'),
('22222222-2222-2222-2222-222222222222', 'AT_RISK', 'launch_pm@demo', 'battery_cells_lfp',
 '{"scope_type":"supplier","scope_id":"SUP_B","sku":"EV-PACK-02","location":"PLANT_2","supplier_name":"Shenzhen LFP Energy"}'::jsonb,
 97, 0.89, 5, '{"signals":["port_delay_days_up","otif_down","schedule_adherence_down"]}'::jsonb, '2025-W03', now() - interval '41 hours', now() - interval '2 hours'),
('33333333-3333-3333-3333-333333333333', 'WATCH', 'quality_launch@demo', 'industrial_ethernet_switch',
 '{"scope_type":"supplier","scope_id":"SUP_C","sku":"EDGE-SWITCH-8","location":"DC_C","supplier_name":"Orion Edge Components"}'::jsonb,
 61, 0.66, 28, '{"signals":["regulatory_alert_score_up","quality_ppm_up"]}'::jsonb, '2025-W03', now() - interval '18 hours', now() - interval '1 hour');
...
('aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111', 'dram_ddr5',
 ...
 'DDR5 watchlist for charger controllers',
...
('bbbbbbb2-bbbb-bbbb-bbbb-bbbbbbbbbbb2', '22222222-2222-2222-2222-222222222222', 'battery_cells_lfp',
 '{"site":"PLANT_2","customer_program":"EV Launch Critical Path"}'::jsonb,
